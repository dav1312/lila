...
object I18nKey:
  ...
  object site:
    ...
    val `standardDesc`: I18nKey = "standardDesc"
    val `otherDesc`: I18nKey = "otherDesc"
    val `crazyhouseDesc`: I18nKey = "crazyhouseDesc"
    val `chess960Desc`: I18nKey = "chess960Desc"
    val `kingOfTheHillDesc`: I18nKey = "kingOfTheHillDesc"
    val `threeCheckDesc`: I18nKey = "threeCheckDesc"
    val `antichessDesc`: I18nKey = "antichessDesc"
    val `atomicDesc`: I18nKey = "atomicDesc"
    val `hordeDesc`: I18nKey = "hordeDesc"
