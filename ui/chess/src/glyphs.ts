...
const glyphToSvg: Dictionary<string> = {
  // Inaccuracy
  '?!': prependDropShadow(`
  <circle style="filter:url(#shadow)" class="glyph-inaccuracy" cx="50" cy="50" r="50" />
...
`),
  ...
  // Mistake
  '?': prependDropShadow(`
  <circle style="filter:url(#shadow)" class="glyph-mistake" cx="50" cy="50" r="50" />
...
`),
  ...
  // Blunder
  '??': prependDropShadow(`
  <circle style="filter:url(#shadow)" class="glyph-blunder" cx="50" cy="50" r="50" />
...
`),
  ...
  // Interesting move
  '!?': prependDropShadow(`
  <circle style="filter:url(#shadow)" class="glyph-interesting" cx="50" cy="50" r="50"/>
...
`),
  ...
  // Good move
  '!': prependDropShadow(`
  <circle style="filter:url(#shadow)" class="glyph-good" cx="50" cy="50" r="50" />
...
`),
  ...
  // Brilliant move
  '!!': prependDropShadow(`
  <circle style="filter:url(#shadow)" class="glyph-brilliant" cx="50" cy="50" r="50" />
...
`),
  ...
  '✓': prependDropShadow(`
  <circle style="filter:url(#shadow)" class="glyph-correct" cx="50" cy="50" r="50" />
...
`),
  ...
  '✗': prependDropShadow(`
  <circle style="filter:url(#shadow)" class="glyph-incorrect" cx="50" cy="50" r="50" />
