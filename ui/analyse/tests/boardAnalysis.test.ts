...
function runAnalysis(fen: string): string[] {
  ...
  const shapes = [...detectPins(board), ...detectUndefended(board), ...detectCheckable(board, epSquare)];

  return shapes.map(s => `${s.orig}:${s.brush}`).sort();
}

test('Pin: Absolute (4k3/4p3/8/8/8/4R3/8/K7)', () => {
...
test('Pin: Relative (4q2k/4p2p/8/8/8/4R3/P7/K7)', () => {
...
test('Pin: No pin if trade (k2q1b2/8/3n4/8/1B6/8/7P/7K)', () => {
...
test('Checkable: Promotion (8/2P1k3/8/8/8/8/8/2K5)', () => {
...
test('Undefended: Fork (8/5k2/2p1n3/3P4/8/8/8/2K5)', () => {
...
test('Undefended: Underdefended pawn (6k1/8/8/r7/1b6/P7/1B5P/7K)', () => {
...
test('Undefended: Losing trade (7k/6p1/5p2/r7/1b6/P7/1Q5P/2B4K)', () => {
...
test('Undefended: Defended pawn (order of trades) (6rk/6pp/5p2/r7/1b6/P3Q3/1B5P/7K)', () => {
...
test('Multiple tests (8/6qk/1p2p3/pBn1p1pP/P3PbN1/2P2P2/KP1r2Q1/6R1)', () => {
...
test('Multiple tests (3r2k1/pp3p2/2p1Nnpb/q1B1p3/4P2P/P1N2Pp1/KPPn4/5BQR)', () => {
